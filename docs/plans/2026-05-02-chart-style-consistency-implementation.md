# Chart Style Consistency Implementation Plan

Design doc: `docs/plans/2026-05-02-chart-style-consistency-design.md`

---

## Task 1: Restyle SplitDraw.svelte to use Tailwind classes

<!-- tdd: trivial -->
<!-- checkpoint: done -->

Modify `web/src/components/SplitDraw.svelte`:
- Remove the entire `<style>` block
- Replace all custom CSS class references in the template with Tailwind utility classes
...
Commit: `style: restyle SplitDraw with Tailwind for light theme consistency`

---

## Task 2: Update chart wrapper in Draw.svelte to light background

<!-- tdd: trivial -->
<!-- checkpoint: none -->

Modify `web/src/pages/Draw.svelte` — change the chart wrapper div from:
```
...
Commit: `style: remove dark background from chart wrapper`
